def helpf():
    ...
    print("FLAGS:")
    print("\t-d : Dynamic. This flag indicates if the program will run a dynamic system. If not, not flag is needed. It receives no extra parameters.")
    ...
    print("\t-i : Iterations. If flag '-d' is used, this flag receives 1 parameter, which is the number of iterations the system will do. It must be at least 1 and a maximum of 7.")
